...
const MenuViewCategories = ({nombre, imgPath, category, setViewMenu}) => {
  ...
  return (
    // height:'190px'
    <div className='animate__animated-animate__fadeIn d-flex flex-column border rounded-3 overflow-hidden position-relative my-2' style={{height:'22.5vh', width:'48%'}} onClick={handleClick}>
      { countItem > 0 
